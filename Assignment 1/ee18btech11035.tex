...
\textbf{Time Complexity\brak{T\brak{N}} : }\\
\textbf{T\brak{N}} is the order of the time taken for completion of the algorithm for an input array of length $N$
\begin{align}
...
\textbf{Space Complexity\brak{S\brak{N}} : }\\
\textbf{S\brak{N}} is the order of the Space taken for completion of the algorithm for an input array of length $N$.\\
...
\textbf{Time Complexity :} \textbf{T\brak{N}} is the order of the time taken for completion of the algorithm for an input array of length $N$.\\
...
\textbf{Solution :}
Let us define a vector \textbf{x} as defined in Section 3\brak{Vector\text{ }Representation} in which i indicates the start day and j indicates the end day.\\
...
So, we can write,\\
Maximum Profit = max\brak{A^{T}x} $\forall i<=j \text{ in \textbf{x}}$ \\
